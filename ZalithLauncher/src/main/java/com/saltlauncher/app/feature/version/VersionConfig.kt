...
import com.saltlauncher.app.feature.version.VersionsManager.getSaltVersionPath
import com.saltlauncher.app.setting.AllSettings
import com.saltlauncher.app.utils.stringutils.StringUtils.getStringNotNull
...
class VersionConfig(private var versionPath: File) : Parcelable {
    ...
    fun saveWithThrowable() {
        ...
        val saltVersionPath = getSaltVersionPath(versionPath)
        val configFile = File(saltVersionPath, "VersionConfig.json")
    ...
    companion object CREATOR : Parcelable.Creator<VersionConfig> {
        ...
        fun parseConfig(versionPath: File): VersionConfig {
            ...
            val oldConfigFile = File(getSaltVersionPath(versionPath), "SaltVersion.cfg")
            val configFile = File(getSaltVersionPath(versionPath), "VersionConfig.json")
