...
import com.saltlauncher.app.feature.update.LauncherVersion.FileSize
...
import com.saltlauncher.app.ui.dialog.UpdateDialog
...
class UpdateUtils {
    companion object {
        ...
        fun getDownloadUrl(launcherVersion: LauncherVersion): String {
            ...
            return "https://github.com/SaltLauncher/SaltLauncher/releases/download/" +
                    "${launcherVersion.versionCode}/SaltLauncher-${launcherVersion.versionName}" +
