...
// Base package/namespace for Salt Launcher
val nameId = "com.saltlauncher.app"
val generatedSaltDir = file("$buildDir/generated/source/salt/java")
...
val githubOwner = project.findProperty("salt_github_owner") as? String ?: "YOUR_GITHUB_USERNAME"
// Allow skipping native rebuilds on hosts without x86_64 NDK (e.g., Termux/ARM) and rely on prebuilt jniLibs.
val disableNdkBuild = System.getenv("DISABLE_NDK_BUILD") == "1"
...
android {
    ...
    if (!disableNdkBuild) {
        ...
        logger.warn("BUILD: DISABLE_NDK_BUILD=1 -> skipping ndkBuild, using prebuilt jniLibs")
    }
...
tasks.register("generateInfoDistributor") {
    doLast {
        ...
        generateJavaClass(generatedSaltDir, nameId, "InfoDistributor", constantMap)
    }
}
