...
class UrlManager {
    companion object {
        ...
        val URL_HOME: String
            get() = "https://github.com/$owner/SaltLauncher"
        val URL_RELEASES: String
            get() = "https://github.com/$owner/SaltLauncher/releases"
        val URL_UPDATE_MANIFEST: String
            get() = "https://api.github.com/repos/$owner/SaltLauncher/contents/launcher_version.json"
        val URL_RELEASE_DOWNLOAD_PREFIX: String
            get() = "https://github.com/$owner/SaltLauncher/releases/download/"
        val URL_GITHUB_HOME: String
            get() = "https://api.github.com/repos/$owner/SaltLauncher/contents/"
